...
//            },
    ...
    function section_utility() {
        azh.controls_options = azh.controls_options.concat([
            ...
            {
                "type": "integer-style",
                "selector": "[data-content-width] > div:not(.az-overlay):not(.az-shape-top):not(.az-shape-bottom):not(.az-background-video)",
                "menu": "utility",
                "group": "Layout",
                "property": "max-width",
                "min": "300",
    ...
    function image_utility() {
        ...
        azh.controls_options = azh.controls_options.concat([
            ...
            },
            {
                ...
                "menu": "utility",
                "group": "Image",
                "control_text": "Alt text",
                "control_class": "azh-alt",
                "control_type": "alt",
                "attribute": "alt",
                "selector": '.az-image img'
            },
    ...
    function polygone_utility() {
        ...
        azh.controls_options = azh.controls_options.concat([
            ...
            },
            {
                ...
                "menu": "utility",
                "group": "Polygone tooltip",
                "control_text": "Show on click",
                "control_class": "azh-toggle azh-tooltip-on-click",
                "control_type": "show-on-click",
                "selector": ".az-polygone",
                "class": "az-tooltip-on-click"
            },
            {
                "type": "dropdown-classes",
                "selector": ".az-polygone > .az-tooltip-wrapper",
