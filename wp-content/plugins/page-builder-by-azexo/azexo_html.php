...
define('AZH_PLUGIN_VERSION', '1.27.126');
    ...
    if (empty($azh)) {
        ...
        $azh = array(
            ...
            'i18n' => array(
                ...
                'clone_pack' => esc_html__('Clone pack', 'azh'),
                'remove_pack' => esc_html__('Remove pack', 'azh'),
                ...
                'last_column_can_not_be_deleted' => esc_html__('Last column can not be deleted', 'azh'),
